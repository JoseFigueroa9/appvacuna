...
class VaccinesController extends Component
{
    ...
    {
        $data = Vaccine::select("name","description","stock","alerts","lot_number")->get();
        $pdf = PDF::loadView('livewire.vaccines.generar_pdf', compact('data'));
        return $pdf->download('vacunas.pdf');
    }

    public function generar_excel()
    {
        return Excel::download(new VaccinesExport,'listadevacunas.xlsx');
    }
