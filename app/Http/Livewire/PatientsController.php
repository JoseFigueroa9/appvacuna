...
class PatientsController extends Component
{
    ...
    {
        $data = Patient::all();
        $pdf = PDF::loadView('livewire.patient.generar_pdf2', compact('data'));
        return $pdf->setpaper('a3','landscape')->download('pacientes.pdf');
    }

    public function generar_excel2()
    {
        return Excel::download(new PatientsExport,'listadepacientes.xlsx');
    }
