<div class="sidebar-wrapper sidebar-theme">
    <nav id="compactSidebar">
        <ul class="menu-categories">
            ...
            @can('Ver_Pacientes')
            <li class="">
                <a href="{{url('patients')}}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            @can('Ver_Vacunas')
            <li class="">
                <a href="{{url('vaccines')}}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
                        ...
                        <path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path></svg>
                        </div>
                        <span>Vacunas</span>
                    </div>
                </a>
            ...
            @can('Ver_Asignar')
            <li class="">
                <a href="{{url('asignar')}}" class="menu-toggle" data-active="true">
                    <div class="base-menu">
                        <div class="base-icons">
