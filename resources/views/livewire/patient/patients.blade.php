        ...
        <div class="widget widget-chart-one">
            <div class="widget-heading">
                ...
                <ul class="tabs tab-pills">
                    @can('EXCEL_Pacientes')
                    <li>
                        <a href="{{ route('descargar-excel2')}}" class="tabmenu bg-success" >EXCEL</a>
                    </li>
                    @endcan
                    @can('PDF_Pacientes')
                    <li>
                        <a href="{{ route('descargar-pdf2')}}" class="tabmenu bg-danger" >PDF</a>
                    </li>
                    @endcan
                    @can('Agregar_Pacientes')
                    <li>
