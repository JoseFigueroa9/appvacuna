        ...
        <div class="widget widget-chart-one">
            <div class="widget-heading">
                ...
                <ul class="tabs tab-pills">
                    @can('EXCEL_Vacunas')
                    <li>
                        <a href="{{ route('descargar-excel')}}" class="tabmenu bg-success" >EXCEL</a>
                    </li>
                    @endcan
                    @can('PDF_Vacunas')
                    <li>
                        <a href="{{ route('descargar-pdf')}}" class="tabmenu bg-danger" >PDF</a>
                    </li>
                    @endcan
                    @can('Agregar_Vacunas')
                    <li>
